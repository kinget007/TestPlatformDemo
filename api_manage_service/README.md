...
To optimize the apimanageservice application for production, run:
...
[Service Discovery and Configuration with the JHipster-Registry]: https://jhipster.github.io/documentation-archive/v3.12.1/microservices-architecture/#jhipster-registry
