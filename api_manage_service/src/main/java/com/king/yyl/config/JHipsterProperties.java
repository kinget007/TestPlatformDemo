...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "apimanageservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "apimanageservice API";

        private String description = "apimanageservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "apimanageservice";
