...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "apiservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "apiservice API";

        private String description = "apiservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "apiservice";
