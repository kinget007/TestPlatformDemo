...
public class PropertyBuilder {
    ...
    private enum Processor {
        ...
        BYTE_ARRAY(com.king.yyl.domain.apis.swagger.properties.ByteArrayProperty.class) {
            @Override
            protected boolean isType(String type, String format) {
                return com.king.yyl.domain.apis.swagger.properties.ByteArrayProperty.isType(type, format);
            }

            @Override
            protected com.king.yyl.domain.apis.swagger.properties.ByteArrayProperty create() {
                return new com.king.yyl.domain.apis.swagger.properties.ByteArrayProperty();
            }
        },
        ...
        DATE_TIME(com.king.yyl.domain.apis.swagger.properties.DateTimeProperty.class) {
            @Override
            protected boolean isType(String type, String format) {
                return com.king.yyl.domain.apis.swagger.properties.DateTimeProperty.isType(type, format);
            }

            @Override
            protected com.king.yyl.domain.apis.swagger.properties.DateTimeProperty create() {
                return new com.king.yyl.domain.apis.swagger.properties.DateTimeProperty();
            }
        },
        ...
        INTEGER(com.king.yyl.domain.apis.swagger.properties.BaseIntegerProperty.class) {
            @Override
            protected boolean isType(String type, String format) {
                return com.king.yyl.domain.apis.swagger.properties.BaseIntegerProperty.isType(type, format);
            }

            @Override
            protected com.king.yyl.domain.apis.swagger.properties.BaseIntegerProperty create() {
                return new com.king.yyl.domain.apis.swagger.properties.BaseIntegerProperty();
            }

            @Override
            public Property merge(Property property, Map<PropertyId, Object> args) {
                super.merge(property, args);
                if (property instanceof com.king.yyl.domain.apis.swagger.properties.BaseIntegerProperty) {
                    final com.king.yyl.domain.apis.swagger.properties.BaseIntegerProperty resolved = (com.king.yyl.domain.apis.swagger.properties.BaseIntegerProperty) property;
                    mergeNumeric(resolved, args);
                }
                return property;
            }
        ...
        protected <N extends com.king.yyl.domain.apis.swagger.properties.AbstractNumericProperty> N mergeNumeric(N property, Map<PropertyId, Object> args) {
        ...
        public Property merge(Property property, Map<PropertyId, Object> args) {
            ...
            if (property instanceof com.king.yyl.domain.apis.swagger.properties.AbstractProperty) {
                final com.king.yyl.domain.apis.swagger.properties.AbstractProperty resolved = (com.king.yyl.domain.apis.swagger.properties.AbstractProperty) property;
                ...
                if(args.containsKey(PropertyId.ENUM)) {
                    ...
                    if(values != null) {
                       ...
                       if(property instanceof com.king.yyl.domain.apis.swagger.properties.DateTimeProperty) {
                         com.king.yyl.domain.apis.swagger.properties.DateTimeProperty p = (com.king.yyl.domain.apis.swagger.properties.DateTimeProperty) property;
                         for(String value : values) {
                           try {
                             p._enum(value);
                           }
