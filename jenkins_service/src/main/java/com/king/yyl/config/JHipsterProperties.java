...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jenkinsservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jenkinsservice API";

        private String description = "jenkinsservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jenkinsservice";
