...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "onepass@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "onepass API";

        private String description = "onepass API documentation";
